  ...
  event.res.end(
    JSON.stringify({
      data: <Language[]> [
        ...
        { name: "GO", level: 1, isFav: false, wiki: "", desc: "" },
        ...
        { name: "Kotlin", level: 1, isFav: false, wiki: "", desc: "" },
        { name: "Java", level: 2, isFav: false, wiki: "", desc: "" },
        { name: "Rust", level: 0, isFav: false, wiki: "", desc: "" },
        { name: "C", level: 2, isFav: false, wiki: "", desc: "" },
        { name: "C++", level: 2, isFav: false, wiki: "", desc: "" },
        { name: "Swift", level: 1, isFav: false, wiki: "", desc: "" },
        { name: "HTML", level: 3, isFav: false, wiki: "", desc: "" },
        { name: "CSS", level: 2, isFav: false, wiki: "", desc: "" },
        { name: "PHP", level: 2, isFav: false, wiki: "", desc: "" },
      ],
    }),
  );
});
